...
<html>
    <head>
        ...
        <?php
            $background = $GLOBALS['_-_-_path_-_-_']['_-_-_asset_-_-_']['_-_-_img_-_-_'] . "app/img13.png";
        ?>
    ...
    <body>
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <font style="font-family: Palatino Linotype;font-size: 16px;">Routing there is forbidden.</font>
