...
<html>
    <head>
        ...
        <?php
            $background = $GLOBALS['_-_-_path_-_-_']['_-_-_asset_-_-_']['_-_-_img_-_-_'] . "app/" . $compact['background'];
        ?>
        ...
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <div class="title m-b-md">
                    <?php echo $GLOBALS['_-_-_manifest_-_-_']['_-_-_app_-_-_']; ?>
                </div>
                <font style="font-family: Palatino Linotype;font-size: 16px;">a new vision in coding</font>
